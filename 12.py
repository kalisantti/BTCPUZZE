...
def calculate_wallet_address(private_key):
    ...
    # Usar sha256 novamente para replicar o comportamento do ripemd160
...
def send_email(subject, body, to_email):
    ...
    """
    from_email = "santticonsul@outlook.com"  # Substitua pelo seu e-mail do Outlook
    password = "YelsewMI312@!"  # Substitua pela senha do seu e-mail
...
def search_private_key(start_key, stop_key, wallet, keys_before_jump, jump_size, email):
    ...
    if results:
        ...
        body = f"Chave privada encontrada: {results[0][0]}\nEndereço da carteira correspondente: {results[0][1]}"
